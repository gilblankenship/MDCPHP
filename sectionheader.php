...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo"><img src="assets/img/MDC Logo small.png" alt=""></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="pageportfolio.php">Portfolio</a></li>
          <li><a class="nav-link scrollto" href="pageteam.php">Team</a></li>
